...
def print_troubleshooting():
    ...
    print("   - Make sure Cowork is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Cowork server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Cowork server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Cowork server if not running")
