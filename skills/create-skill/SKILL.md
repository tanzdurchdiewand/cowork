---
name: "create-skill"
description: "Wizard for creating new Cowork skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
author: "Cowork Team"
...
This skill helps you create new Cowork skills that follow the SKILL.md standard.
