...
<p align="center">
    <a href="https://trendshift.io/repositories/11745" target="_blank"><img src="https://trendshift.io/api/badge/repositories/11745" alt="frdel%2Fcowork | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>

[![Cowork Website](https://img.shields.io/badge/Website-agent--zero.ai-0A192F?style=for-the-badge&logo=vercel&logoColor=white)](https://cowork.ai) [![Thanks to Sponsors](https://img.shields.io/badge/GitHub%20Sponsors-Thanks%20to%20Sponsors-FF69B4?style=for-the-badge&logo=githubsponsors&logoColor=white)](https://github.com/sponsors/coworkai) [![Follow on X](https://img.shields.io/badge/X-Follow-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/Coworkai) [![Join our Discord](https://img.shields.io/badge/Discord-Join%20our%20server-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/B8KZKNsPpj) [![Subscribe on YouTube](https://img.shields.io/badge/YouTube-Subscribe-red?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/@CoworkFW) [![Connect on LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/jan-tomasek/) [![Follow on Warpcast](https://img.shields.io/badge/Warpcast-Follow-5A32F3?style=for-the-badge)](https://warpcast.com/cowork)
...
[How to update](./docs/setup/installation.md#how-to-update-cowork) <br>
[Development Setup](./docs/setup/dev-setup.md) •
[Usage](./docs/guides/usage.md)

Or see DeepWiki generated documentation:

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/coworkai/cowork)
...
- Cowork is not a predefined agentic framework. It is designed to be dynamic, organically growing, and learning as you use it.
- Cowork is fully transparent, readable, comprehensible, customizable, and interactive.
- Cowork uses the computer as a tool to accomplish its (your) tasks.
...
A detailed setup guide for Windows, macOS, and Linux with a video can be found in the Cowork Documentation at [this page](./docs/setup/installation.md).
...
docker run -p 50001:80 coworkai/cowork
...
- Cowork is not pre-programmed for specific tasks (but can be). It is meant to be a general-purpose personal assistant. Give it a task, and it will gather information, execute commands and code, cooperate with other agent instances, and do its best to accomplish it.
- It has a persistent memory, allowing it to memorize previous solutions, code, facts, instructions, etc., to solve tasks faster and more reliably in the future.

![Cowork Working](/docs/res/ui_screen2.png)

2. **Computer as a Tool**

- Cowork uses the operating system as a tool to accomplish its tasks. It has no single-purpose tools pre-programmed. Instead, it can write its own code and use the terminal to create and use its own tools as needed.
- The only default tools in its arsenal are online search, memory features, communication (with the user and other agents), and code/terminal execution. Everything else is created by the agent itself or can be extended by the user.
- Tool usage functionality has been developed from scratch to be the most compatible and reliable, even with very small models.
- **Default Tools:** Cowork includes tools like knowledge, code execution, and communication.
- **Creating Custom Tools:** Extend Cowork's functionality by creating your own custom tools.
...
- In the case of the first agent in the chain (Cowork), the superior is the human user; the agent sees no difference.
...
- **Automated configuration** via `C0_SET_` environment variables for deployment automation and easy setup.
...
1. **Cowork Can Be Dangerous!**

- With proper instruction, Cowork is capable of many things, even potentially dangerous actions concerning your computer, data, or accounts. Always run Cowork in an isolated environment (like Docker) and be careful what you wish for.

2. **Cowork Is Prompt-based.**
...
| [Extensions](./docs/developer/extensions.md) | Extending Cowork |
...
- Environment variables can now configure settings via `C0_SET_*` prefix in `.env`
...
- Cowork can now act as MCP Server
- Cowork can use external MCP servers as tools
...
- [Join our Discord](https://discord.gg/B8KZKNsPpj) for live discussions or [visit our Skool Community](https://www.skool.com/cowork).
- [Follow our YouTube channel](https://www.youtube.com/@CoworkFW) for hands-on explanations and tutorials
- [Report Issues](https://github.com/coworkai/cowork/issues) for bug fixes and features
