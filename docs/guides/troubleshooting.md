...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using Cowork.

## Frequently Asked Questions
**1. How do I ask Cowork to work directly on my files or dirs?**
- Place the files/dirs in `/a0/usr`. Cowork will be able to perform tasks on them.
...
**6. How do I integrate open-source models with Cowork?**
...
**7. How can I make Cowork retain memory between sessions?**
Use **Settings → Backup & Restore** and avoid mapping the entire `/a0` directory. See [How to update Cowork](../setup/installation.md#how-to-update-cowork).
...
- Join the Cowork [Skool](https://www.skool.com/cowork) or [Discord](https://discord.gg/B8KZKNsPpj) community.
...
**13. Can Cowork interact with external APIs or services (e.g., WhatsApp)?**
...
* **Performance Issues:** If Cowork is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.
