# Contributing Skills to Cowork

Welcome to the Cowork Skills ecosystem! This guide will help you create, test, and share skills with the community.
...
2. **Test Semantic Recall:**
   Start Cowork and ask questions that should trigger your skill.
...
1. **Fork the Repository:**
   ```bash
   git clone https://github.com/coworkai/cowork.git
   cd cowork
   ```
