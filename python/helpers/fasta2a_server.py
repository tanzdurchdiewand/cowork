...
class AgentZeroWorker(Worker):  # type: ignore[misc]
    """Coworker implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through Coworker."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to Coworker format
            ...
            # Process message through Coworker (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to Coworker UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                ...
                "url": "https://github.com/frdel/cowork"
            }
